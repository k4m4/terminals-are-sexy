...
* [inxi](https://github.com/smxi/inxi) - one command to get every system info: hardware, CPU, drivers, Xorg, Desktop, Kernel, GCC version(s), Processes, RAM usage - you name it.
